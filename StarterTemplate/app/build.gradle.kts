...
android {
  namespace = "com.meta.spatial.samples.templatename"
  compileSdk = 34

  defaultConfig {
    applicationId = "com.meta.spatial.samples.templatename"
    minSdk = 29
...
spatial {
  ...
  scenes {
    ...
    hotReload {
      appPackage.set("com.meta.spatial.samples.templatename")
